...
print_status "Setting up domain name: rrc-inventory.local"
echo ""
...
echo -e "   ${GREEN}$SERVER_IP    rrc-inventory.local${NC}"
echo ""
...
echo "4. ${BLUE}Add this exact line to the hosts file:${NC}"
echo -e "   ${GREEN}$SERVER_IP    rrc-inventory.local${NC}"
echo ""
...
echo ""
echo "Linux/Mac users can run:"
echo -e "${GREEN}echo '$SERVER_IP    rrc-inventory.local' | sudo tee -a /etc/hosts${NC}"
echo ""
echo "To remove the entry later:"
echo -e "${GREEN}sudo sed -i '/rrc-inventory.local/d' /etc/hosts${NC}"
echo -e "${BLUE}================================================${NC}"